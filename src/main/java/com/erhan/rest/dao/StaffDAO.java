...
public interface StaffDAO extends JpaRepository<Staff, Integer> {
	...
	public List<Staff> findByDepartment_Id(Integer id, Pageable pageable);
	...
	public List<Staff> findByFirstNameAndDepartment_Id(String firstName, Integer departmentId, Pageable pageable);
	public List<Staff> findByLastNameAndDepartment_Id(String lastName, Integer departmentId);
	public List<Staff> findByLastNameAndDepartment_Id(String lastName, Integer departmentId, Pageable pageable);
